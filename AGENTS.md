...
This project is indexed by GitNexus as **reactive-tui** (25908 symbols, 52738 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
