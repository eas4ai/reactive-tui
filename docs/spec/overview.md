...
sessions follow that foundation. Only the rendering requirements below are
...
| Embedded terminal sessions | `src/terminal/`; libghostty-rs integration follows renderer |
