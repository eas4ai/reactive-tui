...
| `hooks` | State/effects/timers and clipboard have focused runtime coverage; public gesture/ref APIs remain in the residual inventory | [API-004](../.cairn/mechanisms/api-hook-lifecycle.md), [API-008](../.cairn/mechanisms/api-clipboard.md), API-019 | Gesture event wiring and ref retention/reentry require repair and acceptance; [residual inventory](residual-api-inventory.md) | API-019 review pending |
...
| `platform`, `terminal`, `escape` | Retained platform adapters, child PTYs, parsing and terminal control; native clipboard/terminal records | [API-008](../.cairn/mechanisms/api-clipboard.md), [API-011](../.cairn/mechanisms/api-widget-behavior.md), [API-016](../.cairn/mechanisms/api-entry-points.md), API-019 | [Entry points](application-entry-points.md); Windows ConPTY remains selected; parser, raw-mode and worker ownership subcases remain explicit residual work | API-019 review pending |
| `display`, `theme` | Performance metrics, adaptive FPS and theme/color helpers | [API-015](../.cairn/mechanisms/api-features.md), API-019 | [Performance guide](ADAPTIVE_PERFORMANCE.md); global context isolation, mode reporting and automatic theme propagation need focused acceptance | API-019 review pending |
