...
fn self_center_vs_self_start_changes_x_in_column() {
    ...
    use std::borrow::Cow;
    let root_center = NodeSpec { class: Cow::from("flex flex-col items-start"), text: None, children: vec![
        NodeSpec { class: Cow::from("self-center"), text: Some(Cow::from("C")), children: vec![] },
    ]};
    let root_start = NodeSpec { class: Cow::from("flex flex-col items-start"), text: None, children: vec![
        NodeSpec { class: Cow::from("self-start"), text: Some(Cow::from("S")), children: vec![] },
    ]};
...
fn place_items_center_rows_moves_y() {
    ...
    let root = NodeSpec { class: Cow::from("flex flex-row place-items-center"), text: None, children: vec![
        NodeSpec { class: Cow::from(""), text: Some(Cow::from("X")), children: vec![] },
    ]};
