...
impl Component for TestComponent {
    ...
    fn render(&self, props: &Self::Props, state: &Self::State) -> Element {
        ...
        Element::text(format!("value: {}, updates: {}", props.value, state.update_count))
    }
...
fn test_element_creation() {
    ...
    assert!(matches!(flex.element_type, ElementType::Layout(reactive_tui::component::LayoutType::Flex)));
