...
fn test_css_animation_integration_basic() {
    ...
    let element = Element::component_with_props("AnimatedComponentBasic", AnimatedProps {
...
fn test_multiple_css_animations() {
    ...
    let pulse_element = Element::component_with_props("MultiAnimatedComponent", AnimatedProps {
        message: "Pulse".to_string(),
    })
    .with_class("animate-pulse text-red-500");

    let bounce_element = Element::component_with_props("MultiAnimatedComponent", AnimatedProps {
        message: "Bounce".to_string(),
    })
    .with_class("animate-bounce text-green-500");

    let spin_element = Element::component_with_props("MultiAnimatedComponent", AnimatedProps {
...
fn test_css_animation_cleanup() {
    ...
    {
        let element = Element::component_with_props("CleanupTestComponent", AnimatedProps {
...
fn test_animate_none_disables_animations() {
    ...
    let element = Element::component_with_props("NoAnimationComponent", AnimatedProps {
...
fn test_css_animation_component_id_generation() {
    ...
    let element1 = Element::component_with_props("IdTestComponent", AnimatedProps {
        message: "Instance 1".to_string(),
    })
    .with_class("animate-pulse")
    .with_key("instance-1");

    let element2 = Element::component_with_props("IdTestComponent", AnimatedProps {
