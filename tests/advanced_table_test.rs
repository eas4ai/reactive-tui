...
use reactive_tui::widgets::display::{
    ...
    FilterType, PaginationConfig, VirtualScrollConfig,
    DisplaySize, Alignment,
};
use reactive_tui::widgets::display::table::{TableColumn, TableRow, TableCell};
...
fn create_sample_data() -> (Vec<TableColumn>, Vec<TableRow>) {
    ...
    let rows = sample_data
        ...
        .map(|(id, name, age, dept, salary)| {
            ...
            cells.insert("id".to_string(), TableCell {
            ...
            cells.insert("name".to_string(), TableCell {
            ...
            cells.insert("age".to_string(), TableCell {
            ...
            cells.insert("department".to_string(), TableCell {
            ...
            cells.insert("salary".to_string(), TableCell {
