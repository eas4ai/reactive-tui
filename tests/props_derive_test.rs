...
mod tests {
    ...
    fn test_fluent_api_chaining() {
        ...
        assert_eq!(props.avatar_url, Some("https://example.com/avatar.jpg".to_string()));
    }
...
pub fn run_props_derive_integration_test() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    println!("✅ Basic props: enabled={}, message='{}'", basic_props.enabled, basic_props.message);
    ...
    let button_props = ButtonProps::new()
        ...
        .with_size(24);
    println!("✅ Button props: text='{}', variant='{}', size={}", 
