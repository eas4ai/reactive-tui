...
mod tests {
    ...
    fn test_font_weight_utilities() {
        ...
        let result = apply_font_weight("font-normal", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_font_weight("font-bold", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_font_weight("font-light", sb.clone()).unwrap();
        let _style = result.build();
    ...
    fn test_text_style_utilities() {
        ...
        let result = apply_text_style("italic", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_text_style("underline", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_text_style("line-through", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_text_style("text-center", sb.clone()).unwrap();
        let _style = result.build();
    ...
    fn test_font_size_utilities() {
        ...
        let result = apply_font_size("text-base", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_font_size("text-xl", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_font_size("text-xs", sb.clone()).unwrap();
        let _style = result.build();
    ...
    fn test_line_height_utilities() {
        ...
        let result = apply_line_height("leading-normal", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_line_height("leading-tight", sb.clone()).unwrap();
        let _style = result.build();

        let result = apply_line_height("leading-4", sb.clone()).unwrap();
        let _style = result.build();
