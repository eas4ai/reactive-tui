...
use crate::accessibility::platform::translation::{NodeIdOrRoot, PlatformNode, PlatformRoot};
...
use crate::accessibility::platform::unix::atspi::{ObjectId, OwnedObjectAddress};
...
impl NodeAccessibleInterface {
    ...
    fn map_error(
        &self,
    ) -> impl '_ + FnOnce(crate::accessibility::platform::translation::Error) -> fdo::Error {
        |error| crate::accessibility::platform::unix::util::map_error_from_node(&self.node, error)
    }
}
